...
Some major difference are explained that the newer anthropic models are not only much stronger at coding via RL but also are multimodal and can now ingest images. Furthermore, the agent tooling has also gotten much stronger. One thing of note was time to write was much higher (also token cost was very high), I'm actually suprised how slow claude is compared to other models/agent clis I have tested. It took 10 mins sometimes to write a feature, though it did not make any major mistakes besides a stroboscopic effect at one point. 
